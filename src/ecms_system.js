...
if (document.getElementById) {
	...
	document.writeln('<script language="Javascript" type="text\/javascript" src="\/js\/ecms\/ecms_system_id.js"><\/script>');
} else if (document.layers) {
	// layers (Netscape 4, 3)
	document.writeln('<script language="Javascript" type="text\/javascript" src="\/js\/ecms\/ecms_system_layer.js"><\/script>');
} else {
	// default - uses UL/LI display
	document.writeln('<script language="Javascript" type="text\/javascript" src="\/js\/ecms\/ecms_system_default.js"><\/script>');
}
