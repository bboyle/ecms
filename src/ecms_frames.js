...
// netscape resize bug
if (document.layers) {
	document.writeln('<p class="error"><strong>Netscape 4 users:</strong> if you do not see the menu, <a href="javascript:location.reload();" target="_self">reload this frame</a>.</p>');
}
